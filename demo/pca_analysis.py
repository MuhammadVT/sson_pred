...
def pca_analysis(omnHistory=120,
    ...
    """
    Performs PCA analysis to the input and plots the first three principal components.
    ...
    threeD_plot -- plots the output in 3D if set to True
    ...
    # Add suffix to saved figure name
    if threeD_plot:
        threeD_txt = "_3D"
    else:
        threeD_txt = ""
