...
classes_are_exclusive = False    # Corresponds to sigmoid activation layer
#classes_are_exclusive = True    # Corresponds to softmax activation layer
