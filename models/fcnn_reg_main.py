...
from dnn_regressors import FCNN_Reg, train_model
...
if useSML:
    ...
    out_dir="./trained_models/FCNN_Reg/" + omnDir + \
...
if not skip_training:
    dl_mdl = FCNN_Reg(input_shape, batch_size=batch_size, n_epochs=n_epochs,
...
#df_test.loc[_idx, "del_minutes_pred"] = y_test_pred
